        ...
        if (0 === strpos($pathinfo, '/admin')) {
            if (0 === strpos($pathinfo, '/admin/koi')) {
                ...
                if (0 === strpos($pathinfo, '/admin/koi/element')) {
                    // admin_koi_element_list
                    if ($pathinfo === '/admin/koi/element/list') {
                        return array (  '_controller' => 'KoiBundle\\Controller\\Admin\\ElementAdminController::listAction',  '_sonata_admin' => 'element.service',  '_sonata_name' => 'admin_koi_element_list',  '_route' => 'admin_koi_element_list',);
                    }
