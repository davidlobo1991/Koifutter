 ...
 */
class FeedElement extends \KoiBundle\Entity\FeedElement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KoiBundle\\Entity\\FeedElement' . "\0" . 'idFeed', '' . "\0" . 'KoiBundle\\Entity\\FeedElement' . "\0" . 'idElement', '' . "\0" . 'KoiBundle\\Entity\\FeedElement' . "\0" . 'amount'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FeedElement $proxy) {
