...
class __TwigTemplate_282e937fcd50ab8d4c7c2ba91defb7d9e7f2aa1d5cf6cc383b3cb9da5d76cf07 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 41
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 41)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? null)));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 67
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 67)->display(array("logs" => $this->getAttribute(($context["logger"] ?? null), "logs", array())));
            // line 68
            echo "        </div>
    </div>
";
...
";
        // line 92
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 92)->display(array("exception" => ($context["exception"] ?? null)));
        // line 93
        echo "
...
";
    ...
    {
        return new Twig_Source("", "@Twig/Exception/exception.html.twig", "C:\\Users\\David\\Projekte\\Koifutter\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\Resources\\views\\Exception\\exception.html.twig");
    }
}
